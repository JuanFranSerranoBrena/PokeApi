...
import mx.uacj.pokemon_api.ui.pantallas.PantallaMaquina
...
@Composable
fun MenuPrincipal(){ //No supe como mandarlas a llamar para que se muestren
    val lista_opciones_menu by remember {  mutableStateOf(
        mutableStateListOf(
            OpcionesMenu("Pokemon", "icono", "PantallaPokemones"),
            OpcionesMenu("Ubicaciones", "icono", "PantallaUbicaciones"),
            OpcionesMenu("Maquinas", "icono", "PantallaMaquinas"),
            )
        )
    }

    val (pantallaActual, setPantallaActual) = remember { mutableStateOf("PantallaPokemones") }
